...
# db.insert("4GB DDR4 Ram", "Sayak Basu", "Microsoft", "160")
# db.insert("4GB DDR3 Ram", "Sucharitam Chowdhury", "Microsoft", "660")
# db.insert("2GB DDR4 Ram", "Suman Kumar Dey", "Microsoft", "760")
